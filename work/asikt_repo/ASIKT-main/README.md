# ASIKT
code for paper: [Interpretable Knowledge Tracing with Difficulty-Aware Attention and Selective State Space Model](https://dl.acm.org/doi/10.1145/3726302.3730012)
## Requirements
python 3.9+  
torch 2.0.1  
numpy 1.26.0  
